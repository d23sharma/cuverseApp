...
import 'nav360_video_landscape_model.dart';
export 'nav360_video_landscape_model.dart';

class Nav360VideoLandscapeWidget extends StatefulWidget {
  const Nav360VideoLandscapeWidget({super.key});

  @override
  State<Nav360VideoLandscapeWidget> createState() =>
      _Nav360VideoLandscapeWidgetState();
}

class _Nav360VideoLandscapeWidgetState
    extends State<Nav360VideoLandscapeWidget> {
  late Nav360VideoLandscapeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Nav360VideoLandscapeModel());
  }
                                  ...
                                  children: [
                                    ...
                                    Material(
                                      ...
                                      child: Container(
                                        ...
                                        child: wrapWithModel(
                                          model: _model.availUnitNumBtnModel,
                                          updateCallback: () => setState(() {}),
                                          child: AvailUnitNumBtnWidget(),
                                        ),
                                      ),
                                    ),
                                    Container(
